      ...
      <div className="space-y-8 p-6">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300 text-sm font-semibold uppercase tracking-wider">Compliance</span>
                </div>
        ...
        <div className="card">
          ...
          <p className="text-gray-600">
            This page is for regulatory compliance and reporting. Content coming soon.
          </p>
        </div>
      </div>
    </div>
