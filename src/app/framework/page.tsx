  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="space-y-8 p-6">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300 text-sm font-semibold uppercase tracking-wider">Framework</span>
                </div>
        ...
        {/* Content */}
        <div className="card">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Framework Documentation</h2>
          <p className="text-gray-600">
            This page contains framework and methodology documentation. Content coming soon.
          </p>
        </div>
      </div>
    </div>
